cheatsheet do
  ...
  category do
    ...
    entry do
      command 'ALT + G'
      name 'Move Selected Object to Center'
    end
    entry do
      command 'SHIFT + S'
      name 'Snap to cursor'
    ...
    entry do
      command 'CTRL + L'
      name 'Copy Attributes to New Object'
    end
    entry do
      command 'O'
      name 'Proportional Editing On/Off'
    end
    entry do
      command 'CTRL + A'
      name 'Apply Scale/Rotation/Location'
    end
    entry do
